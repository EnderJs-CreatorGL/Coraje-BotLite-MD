...
m.react(done)
await conn.reply(m.chat, `🌳 *Ejcutado${filesDeleted} fueron borrados de Coraje-BotLite-MD,excepto las creds.json*`,  m, rcanal, )
conn.reply(m.chat, `🌲 *¡Hola! soy coraje-Bot ¿logras leerme?*`, m, rcanal, )
